...
Original file is located at
    https://colab.research.google.com/drive/16yJh0WMaKGaqubncDMFtJ8imi0op1Gg6
"""
...
if __name__=='__main__':
  ...
  for categorie in categories:
    rdd_lst.append(get_info(categorie).collect())

  visit_data = []
  for lst in rdd_lst:
    visit_data.append(get_visit_data(lst))

  visit_day_count = []
  for data in visit_data:
    visit_day_count.append(data.flatMap(visit_per_day))


  res_table = []
  for count in visit_day_count:
    res_table.append(get_res_table(count))
